...
<head>
    ...
    <script src="/music/Application/Admin/Public/js/menu.js"></script>
</head>
<body>
            ...
            <ul id="nav">
                <li id="lidaily">
                    ...
                    <ul id="ChildMenu1" class="collapsed">
                        <li id="lidaily1">
                            <a href="/music/index.php/Admin/ImportWorkOrder/index" target="mainframe">工单数据导入</a>
                        </li>
                        <li id="lidaily2">
                            <a href="module/daily_manage/work.order.assign.php" target="mainframe">工单分配</a>
                        </li>
			            <li id="lidaily3">
                            <a href="module/daily_manage/work.order.down.php" target="mainframe">工单下载</a>
                        </li>
                        <li id="lidaily4">
                            <a href="module/daily_manage/work.order.modify.php" target="mainframe">工单修改/查询</a>
                        </li>                       
			            <li id="lidaily5">
                            <a href="module/daily_manage/work.order.discomplete.php" target="mainframe">未完结项目</a>
                        </li>
                        <li id="lidaily6">
                ...
                <li id="licopy">
                    ...
                    <ul id="ChildMenu2" class="collapsed">
                        <li id="licopy1">
                            <a href="module/copyright_manage/copyright.import.php" target="mainframe">版权材料导入</a>
                        </li>
                        <li id="licopy2">
                            <a href="module/copyright_manage/copyright.storage.php" target="mainframe">版权登记</a>
                        </li>
                        <li id="licopy3">
                            <a href="module/copyright_manage/copyright.stmodify.file.php" target="mainframe">版权材料修改/归档</a>
                        </li>
                        <li id="licopy4">
                            <a href="module/copyright_manage/copyright.query.php" target="mainframe">版权材料查询</a>
                        </li>                       
                    </ul>
                </li>
                <li id="lidis">
				...
				<li id="lisys">
                    ...
                    <ul id="ChildMenu10" class="collapsed">
                        ...
                        <li id="lisys2">
                            <a href="/music/index.php/Admin/Rbac/role" target="mainframe">角色列表</a>
                        </li>                      
			            <li id="lisys3">
                        ...
                        <li id="lisys5">
                            <a href="/music/index.php/Admin/Rbac/addRolePage" target="mainframe">添加角色</a>
                        </li>
                        <li id="lisys6">

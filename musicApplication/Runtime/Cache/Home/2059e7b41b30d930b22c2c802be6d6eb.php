...
<head>
    ...
    <script>
        var URL="/index.php/home/login/verify";
    </script> 
...
<body>
    <div id="container">
    	<div id="login-top">
    		<a href="javascript:void(0);" id="logo-law" title="中国移动通信集团"><img src="/Public/images/logo-mobile.png"></img></a>
			<a href="javascript:void(0);" id="logo-law" title="泰和泰律师事务所"><img src="/Public/images/logo-law.png"></img></a>
    	</div>
        <div id="content">
            ...
            <div class="login-mid">
                <form id="frm" method="" action="">
                    ...
                    <div class="input-content-item">
						...
						<img id="img" src="/index.php/home/login/verify" class="fl ml5 code-img" onclick="changeCode()" style="cursor:pointer"></img>
                    </div>                        

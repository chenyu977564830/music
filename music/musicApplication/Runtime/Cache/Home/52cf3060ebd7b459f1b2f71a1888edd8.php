...
<head>
    ...
    <script src="http://www.music.com/Public/Home/js/menu.js"></script>
</head>
<body>
            ...
            <ul id="nav">
                <li id="lidaily">
                    ...
                    <ul id="ChildMenu1" class="collapsed">
                        <li id="lidaily1">
                            <a href="/Home/ImportWorkOrder/index" target="mainframe">工单数据导入</a>
                        </li>
                        <li id="lidaily2">
                            <a href="/Home/DistributeOrder/index" target="mainframe">工单分配</a>
                        </li>
			            <li id="lidaily3">
                            <a href="/Home/DownloadOrder/index" target="mainframe">工单下载</a>
                        </li>
                        <li id="lidaily4">
                            <a href="/Home/OrderStatus/index" target="mainframe">工单修改/查询</a>
                        </li>                       
			            <li id="lidaily5">
                ...
                <li id="licopy">
                    ...
                    <ul id="ChildMenu2" class="collapsed">
                        <li id="licopy1">
                            <a href="/Home/CrImport/index" target="mainframe">入库登记</a>
                        </li>
                        <li id="licopy2">
				...
				<li id="lisys">
                    ...
                    <ul id="ChildMenu10" class="collapsed">
                        ...
                        <li id="lisys2">
                            <a href="/Home/Rbac/role" target="mainframe">角色列表</a>
                        </li>                      
			            <li id="lisys3">
                        ...
                        <li id="lisys5">
                            <a href="/Home/Rbac/addRolePage" target="mainframe">添加角色</a>
                        </li>
                        <li id="lisys6">

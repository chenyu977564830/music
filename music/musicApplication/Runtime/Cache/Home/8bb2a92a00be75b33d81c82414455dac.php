...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body style="background:url(/Public/images/background.png) repeat-x;">
        <div id="main-frame">
            <div style="margin-top:280px;width:80%;height:100%;margin-left:auto;margin-right:auto;padding:20px 0 20px 0; background:url(/Public/images/1.jpg)"" >

...
<head>
    ...
    <script src="/music/Public/js/jquery-1.4.4.min.js"></script>
    <script src="/music/Public/js/menu.js"></script>
</head>
<body>
            ...
            <ul id="nav">
                <li id="lidaily">
                    ...
                    <ul id="ChildMenu1" class="collapsed">
                        <li id="lidaily1">
                            <a href="/music/index.php/Home/ImportWorkOrder/index" target="mainframe">工单数据导入</a>
                        </li>
                        <li id="lidaily2">
                            <a href="/music/index.php/Home/DistributeOrder/index" target="mainframe">工单分配</a>
                        </li>
			            <li id="lidaily3">
                            <a href="/music/index.php/Home/DownloadOrder/index" target="mainframe">工单下载</a>
                        </li>
                        <li id="lidaily4">
                ...
                <li id="licopy">
                    ...
                    <ul id="ChildMenu2" class="collapsed">
                        <li id="licopy1">
                            <a href="/music/index.php/Home/CrImport/index" target="mainframe">入库登记</a>
                        </li>
                        <li id="licopy2">
				...
				<li id="lisys">
                    ...
                    <ul id="ChildMenu10" class="collapsed">
                        ...
                        <li id="lisys2">
                            <a href="/music/index.php/Home/Rbac/role" target="mainframe">角色列表</a>
                        </li>                      
			            <li id="lisys3">
                        ...
                        <li id="lisys5">
                            <a href="/music/index.php/Home/Rbac/addRolePage" target="mainframe">添加角色</a>
                        </li>
                        <li id="lisys6">
